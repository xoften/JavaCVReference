...
/**
 * Gui implementation of Histogram from exercise 1 lab 4, 1DV506
 * start of program show no chart, when choosing file create chart.
 * when choosing new file clear all old variables.
 * Created by Michael Johansson(mj223gn) on 2016-02-12.
 */

public class HistogramGUI extends Application {

    private Text notInIntervalText;
    private Text totalNumbers;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //Text for GUI
        fileName = new Text("Current File: ");

        totalNumbers = new Text("Total number of integers: ");
        totalNumbers.setStyle("-fx-font-size: 30");

        notInIntervalText = new Text("Integers not in interval 1-100: ");
     ...
     */
    private int histogram(ArrayList<Integer> ints, int min, int max) {
    ...
    private Alert error(){
        ...
        alert.setHeaderText("No integers");
        alert.setContentText("There is no integers in the file, try with a new file!");
    ...
    public void createChart(){
        ...
        if (selectedFile != null) {
            ...
            for (int i = 0; i < NUMBER_OF_INTERVALS; i++) {
                ...
                interval.getData().add(new Data<>(minInterval + "-" + maxInterval, histogram(integersInInterval, minInterval, maxInterval)));
